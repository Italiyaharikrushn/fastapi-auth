...
Revision ID: 00028f85e19a
Revises: 7c9b4de4903a
Create Date: 2025-03-24 14:26:34.435440
...
def upgrade():
    ...
    sa.Column('billing_fullname', sa.String(), nullable=False),
    ...
    sa.Column('billing_pincode', sa.String(), nullable=False),
    sa.Column('billing_country', sa.String(), nullable=False),
    sa.Column('billing_contact_number', sa.String(), nullable=False),
